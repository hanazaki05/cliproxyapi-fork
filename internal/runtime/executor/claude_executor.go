...
func (e *ClaudeExecutor) Execute(ctx context.Context, auth *cliproxyauth.Auth, req cliproxyexecutor.Request, opts cliproxyexecutor.Options) (resp cliproxyexecutor.Response, err error) {
	...
	if errHeaders := applyClaudeHeaders(httpReq, auth, apiKey, false, extraBetas, baseModel, e.cfg, opts.Headers); errHeaders != nil {
...
func (e *ClaudeExecutor) ExecuteStream(ctx context.Context, auth *cliproxyauth.Auth, req cliproxyexecutor.Request, opts cliproxyexecutor.Options) (_ *cliproxyexecutor.StreamResult, err error) {
	...
	if errHeaders := applyClaudeHeaders(httpReq, auth, apiKey, true, extraBetas, baseModel, e.cfg, opts.Headers); errHeaders != nil {
...
func applyClaudeHeaders(r *http.Request, auth *cliproxyauth.Auth, apiKey string, stream bool, extraBetas []string, model string, cfg *config.Config, incomingHeaders http.Header) error {
	if r == nil {
		return nil
	}
